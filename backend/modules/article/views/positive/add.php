...
?>
<form name="myform" id="myform" action="<?=Url::toRoute(['/article/positive/add']) ?>" method="post">
    <div class="common-form">
        <table width="100%" class="table_form contentWrap">
            ...
            <tr>
                <th width="80">能量标题：</th>
                <td>
                    <input class="form-control menu_source" value="" style="width:200px" placeholder="请输入正能量文章标题" name="title">
