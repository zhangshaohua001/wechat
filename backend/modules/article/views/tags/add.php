...
<div class="pad_10">
    <div class="common-form">
        <form name="myform" action="<?php echo Url::toRoute('/article/tags/add'); ?>" method="post" id="myform">
            <div class="common-form">
            <table width="100%" class="table_form contentWrap">
                ...
                <tr>
                    <th width="100">标题：</th>
                    <td><input type="text" name="name" value="" class="form-control-table width-160" id="name" style="display: inline" >
