...
?>
<form name="myform" id="myform"  action="<?=Url::toRoute(['/article/news/add']) ?>" method="post" enctype="multipart/form-data">
    <div class="common-form">
        <table width="100%" class="table_form contentWrap">
            ...
            <tr>
                <th width="80">标题：</th>
                <td>
                    <input class="form-control menu_source" value="" style="width:200px;" placeholder="请输入原创新闻标题" name="title">
                    <span id="nameTip" style="color:red;display:none;">请输入新闻标题</span>
                </td>
            </tr>
            <tr>
                <th width="100">列表名：</th>
