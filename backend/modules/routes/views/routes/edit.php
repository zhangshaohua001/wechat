...
use yii\helpers\Url;
?>
<form name="myform" id="myform" enctype="multipart/form-data" action="<?=Url::toRoute(['/routes/routes/edit','id' => $model->id]) ?>" method="post">
    <div class="common-form">
        <table width="100%" class="table_form contentWrap">
            ...
            <tr>
                <th width="80">导航名称：</th>
                <td>
                    <input class="form-control menu_source"  id="name" name="name" value="<?=$model->name;?>" style="width:200px;">
            ...
            <tr>
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <option <?php if($model->parent_id == 0) echo 'selected';?> value="0">一级导航</option>
                        <?php foreach ($menus as $val): ?>
                            <option <?php if($model->parent_id == $val['id']) echo 'selected';?> value="<?= $val['id'];?>"><?= $val['name'];?></option>
            ...
            <tr>
                <th width="80">URL：</th>
                <td>
                    <input class="form-control menu_source"  id="url" name="url" value="<?=$model->url;?>" style="width:200px;">
            ...
            <tr>
                <th width="80">是否列表：</th>
                <td>
                    <input class="" <?=$model->tag==1 ? "checked='checked'" : "";?>  type="radio" id="tag" name="tag" value="1" style="width:40px;">是
                    <input class="" <?=$model->tag==0 ? "checked='checked'" : "";?>  type="radio" id="tag" name="tag" value="0" style="width:40px;">否
                </td>
            </tr>
            <tr>
                <th width="80">顺序：</th>
