...
use yii\helpers\Url;
?>
<form name="myform" id="myform"  action="<?=Url::toRoute(['/routes/loop/add']) ?>" method="post" enctype="multipart/form-data">
    <div class="common-form">
        <table width="100%" class="table_form contentWrap">
            ...
            <tr>
                <th width="80">标题：</th>
                <td>
                    <input class="form-control menu_source"  id="title" name="title" value="" style="width:200px;">
